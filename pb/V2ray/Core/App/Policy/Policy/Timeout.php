 ...
 *
 * Generated from protobuf message <code>v2ray.core.app.policy.Policy.Timeout</code>
 */
class Timeout extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.v2ray.core.app.policy.Second handshake = 1;</code>
     */
    protected $handshake = null;
    /**
     * Generated from protobuf field <code>.v2ray.core.app.policy.Second connection_idle = 2;</code>
     */
    protected $connection_idle = null;
    /**
     * Generated from protobuf field <code>.v2ray.core.app.policy.Second uplink_only = 3;</code>
     */
    protected $uplink_only = null;
    /**
     * Generated from protobuf field <code>.v2ray.core.app.policy.Second downlink_only = 4;</code>
     */
     ...
     *
     *     @type \V2ray\Core\App\Policy\Second $handshake
     *     @type \V2ray\Core\App\Policy\Second $connection_idle
     *     @type \V2ray\Core\App\Policy\Second $uplink_only
     *     @type \V2ray\Core\App\Policy\Second $downlink_only
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.v2ray.core.app.policy.Second handshake = 1;</code>
     * @return \V2ray\Core\App\Policy\Second|null
     */
    ...
    /**
     * Generated from protobuf field <code>.v2ray.core.app.policy.Second handshake = 1;</code>
     * @param \V2ray\Core\App\Policy\Second $var
     * @return $this
     */
    public function setHandshake($var)
    {
        GPBUtil::checkMessage($var, \V2ray\Core\App\Policy\Second::class);
        $this->handshake = $var;
