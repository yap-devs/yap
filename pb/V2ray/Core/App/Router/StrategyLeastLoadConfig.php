...
/**
 * Generated from protobuf message <code>v2ray.core.app.router.StrategyLeastLoadConfig</code>
 */
class StrategyLeastLoadConfig extends \Google\Protobuf\Internal\Message
{
     ...
     * weight settings
     *
     * Generated from protobuf field <code>repeated .v2ray.core.app.router.StrategyWeight costs = 2;</code>
     */
    private $costs;
    /**
     ...
     *
     *     @type array<\V2ray\Core\App\Router\StrategyWeight>|\Google\Protobuf\Internal\RepeatedField $costs
     *           weight settings
     ...
     *
     * Generated from protobuf field <code>repeated .v2ray.core.app.router.StrategyWeight costs = 2;</code>
     * @param array<\V2ray\Core\App\Router\StrategyWeight>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setCosts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \V2ray\Core\App\Router\StrategyWeight::class);
        $this->costs = $arr;
