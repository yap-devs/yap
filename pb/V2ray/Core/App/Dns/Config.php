...
/**
 * Generated from protobuf message <code>v2ray.core.app.dns.Config</code>
 */
class Config extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .v2ray.core.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
     * @deprecated
     */
    private $NameServers;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.NameServer name_server = 5;</code>
     */
    private $name_server;
    /**
     ...
     *
     * Generated from protobuf field <code>map<string, .v2ray.core.common.net.IPOrDomain> Hosts = 2 [deprecated = true];</code>
     * @deprecated
     */
    private $Hosts;
    /**
     ...
     *
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.HostMapping static_hosts = 4;</code>
     */
     ...
     *
     *     @type array<\V2ray\Core\Common\Net\Endpoint>|\Google\Protobuf\Internal\RepeatedField $NameServers
     *           Nameservers used by this DNS. Only traditional UDP servers are support at
     *           the moment. A special value 'localhost' as a domain address can be set to
     *           use DNS on local system.
     *     @type array<\V2ray\Core\App\Dns\NameServer>|\Google\Protobuf\Internal\RepeatedField $name_server
     *           NameServer list used by this DNS client.
     ...
     *           Client IP for EDNS client subnet. Must be 4 bytes (IPv4) or 16 bytes
     *           (IPv6).
     *     @type array<\V2ray\Core\App\Dns\HostMapping>|\Google\Protobuf\Internal\RepeatedField $static_hosts
     *           Static domain-ip mapping in DNS server.
     ...
     *
     * Generated from protobuf field <code>repeated .v2ray.core.common.net.Endpoint NameServers = 1 [deprecated = true];</code>
     * @param array<\V2ray\Core\Common\Net\Endpoint>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     * @deprecated
     */
    ...
    {
        @trigger_error('NameServers is deprecated.', E_USER_DEPRECATED);
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \V2ray\Core\Common\Net\Endpoint::class);
     ...
     *
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.NameServer name_server = 5;</code>
     * @param array<\V2ray\Core\App\Dns\NameServer>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setNameServer($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \V2ray\Core\App\Dns\NameServer::class);
    ...
    {
        @trigger_error('Hosts is deprecated.', E_USER_DEPRECATED);
        $arr = GPBUtil::checkMapField($var, \Google\Protobuf\Internal\GPBType::STRING, \Google\Protobuf\Internal\GPBType::MESSAGE, \V2ray\Core\Common\Net\IPOrDomain::class);
        $this->Hosts = $arr;
     ...
     *
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.HostMapping static_hosts = 4;</code>
     * @param array<\V2ray\Core\App\Dns\HostMapping>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setStaticHosts($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \V2ray\Core\App\Dns\HostMapping::class);
