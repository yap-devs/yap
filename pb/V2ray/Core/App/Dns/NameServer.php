...
/**
 * Generated from protobuf message <code>v2ray.core.app.dns.NameServer</code>
 */
class NameServer extends \Google\Protobuf\Internal\Message
{
    ...
    protected $tag = '';
    /**
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.NameServer.PriorityDomain prioritized_domain = 2;</code>
     */
    ...
    private $geoip;
    /**
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.NameServer.OriginalRule original_rules = 4;</code>
     */
     ...
     *     @type string $tag
     *     @type array<\V2ray\Core\App\Dns\NameServer\PriorityDomain>|\Google\Protobuf\Internal\RepeatedField $prioritized_domain
     *     @type array<\V2ray\Core\App\Router\Routercommon\GeoIP>|\Google\Protobuf\Internal\RepeatedField $geoip
     *     @type array<\V2ray\Core\App\Dns\NameServer\OriginalRule>|\Google\Protobuf\Internal\RepeatedField $original_rules
    ...
    /**
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.NameServer.PriorityDomain prioritized_domain = 2;</code>
     * @param array<\V2ray\Core\App\Dns\NameServer\PriorityDomain>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPrioritizedDomain($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \V2ray\Core\App\Dns\NameServer\PriorityDomain::class);
    ...
    /**
     * Generated from protobuf field <code>repeated .v2ray.core.app.dns.NameServer.OriginalRule original_rules = 4;</code>
     * @param array<\V2ray\Core\App\Dns\NameServer\OriginalRule>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOriginalRules($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \V2ray\Core\App\Dns\NameServer\OriginalRule::class);
